...
<html lang="en">
		 ...
		 <form action="#" method="post">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default" style="background-color:white;border:5px solid gold;border-radius:100px;height:400px">
                        <div class="panel-heading" style="width:200px;margin-left:70px;margin-bottom:50px;margin-top:50px">
                            <h3 class="panel-title"><center><h3>Admin Login</h3></center>
                        </div>
                        <div class="panel-body">
                            <form role="form">
                                <fieldset >
                                    ...
                                    <input type="submit" class="btn btn-info btn-block" style="border-radius:25px; width:100px;margin-left:100px;margin-top:20px" title="Log In" name="login" value="Login"></input>
                                </fieldset>
	...
	<footer class="page-footer font-small special-color-dark pt-4">
		...
		<div class="footer-copyright text-center py-3">© <?php echo date("Y"); ?>
		 BIJJAM RAMA SAI MAHESWARA REDDY TEMA
		</div>
		<!-- Copyright -->
