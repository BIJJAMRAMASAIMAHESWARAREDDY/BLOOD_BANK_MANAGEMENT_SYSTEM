...
<body>
	...
	<div class="container h-100" style="background-color:aqua-blue;">
		
		<div class="d-flex justify-content-center px-5 h-100">
			<div class="user_card rounded-circle" style="border:5px solid gold; border-radius 90px">
				...
				<div class="d-flex justify-content-center form_container">
					<form action="#" method="post">
				 	...
				 	<button type="submit" name="userlogin" style="border-radius: 25%" class="btn login_btn">User Login</button>
				   </div>
					</form>
				</div>
  ...
  ?>
				...
				<div class="mt-4">
					...
					<div class="d-flex justify-content-center links">
						<a href="../" style="text-decoration:none; color: white; margin-bottom:25px">Back to Admin Panel</a>
					</div>
				</div>
			</div>
		</div>
