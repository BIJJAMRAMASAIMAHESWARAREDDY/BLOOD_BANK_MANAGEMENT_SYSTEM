...
(8, 'Saving Lives Together', 'demo organizer', 1597534560, '2018-06-21', 'ALL SHOULD DONATE SOME BLOOD SO THAT IT IS VERY USEFUL TO THE PEOPLE WHO NEED IT . DONATING BLOOD WILL BE USEFUL TO ALL THE PEOPLE SO DONATE BLOOD ATLEAST ONCE.');
...
INSERT INTO `bloodrequest` (`id`, `bloodgroup`,  `address`, `quantity`) VALUES
(18,  'b+', 'KIMS', '20'),
(19,  'B+', 'ramesh hospital', '20'),
(20,  'B+', 'VLIT', '20'),
(21,  'AB+', 'KHIT', '20'),
(22, 'O-', 'ponnur', '20'),
(23,  'AB-','guntur', '20');
